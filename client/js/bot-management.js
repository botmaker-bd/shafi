class BotManager {
    ...
    async loadBots() {
        ...
        try {
            ...
            if (data.success) {
                ...
                this.showNotification('Failed to load bots', 'error');
            }
        } catch (error) {
            this.showNotification('Network error while loading bots', 'error');
        } finally {
    ...
    async addNewBot() {
        ...
        if (!token) {
            this.showNotification('Please enter bot token', 'error');
            return;
        }
        ...
        try {
            ...
            if (response.ok) {
                this.showNotification('Bot added successfully!', 'success');
                tokenInput.value = '';
                nameInput.value = '';
                await this.loadBots();
            } else {
                this.showNotification(data.error || 'Failed to add bot', 'error');
            }
        } catch (error) {
            this.showNotification('Network error while adding bot', 'error');
        } finally {
            this.showLoading(false);
        }
    }
    ...
    async testBotToken() {
        ...
        if (!token) {
            this.showNotification('Please enter bot token to test', 'error');
            return;
        }
    ...
    async testBot(botId) {
        ...
        try {
            ...
            if (response.ok) {
                this.showNotification(`Bot connection successful! Name: ${data.botInfo.name}`, 'success');
            } else {
                this.showNotification(data.error || 'Failed to test bot', 'error');
            }
        } catch (error) {
            this.showNotification('Network error while testing bot', 'error');
        } finally {
            this.showLoading(false);
        }
    }
